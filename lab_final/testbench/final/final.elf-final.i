# 0 "final.c"
# 1 "/home/ubuntu/soc/lab_final/testbench/final//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "final.c"
# 19 "final.c"
...
# 1 "final.h" 1
# 29 "final.h"
int __attribute__ ( ( section ( ".fir_tap" ) ) ) taps[11];
int __attribute__ ( ( section ( ".fir_x" ) ) ) inputsignal[16];
int __attribute__ ( ( section ( ".fir_y" ) ) ) outputsignal[16];


int __attribute__ ( ( section ( ".mm_a" ) ) ) Am[16];
int __attribute__ ( ( section ( ".mm_b" ) ) ) Bm[16];
int __attribute__ ( ( section ( ".mm_o" ) ) ) Mo[16];


int __attribute__ ( ( section ( ".qs_a" ) ) ) Aq[16];
int __attribute__ ( ( section ( ".qs_o" ) ) ) Vo[16];
...
# 79 "final.c"
    ...
    (*(volatile uint32_t*)0x26000038) = 0x1809;
    ...
    (*(volatile uint32_t*)0x260000ac) = 0x1808;
    (*(volatile uint32_t*)0x260000a8) = 0x0402;
    (*(volatile uint32_t*)0x260000a4) = 0x1808;
 ...
 (*(volatile uint32_t*) ((0xf0000000L + 0x3010L) + 8)) = (*(volatile uint32_t*) ((0xf0000000L + 0x3000L) + 8)) = 0x00000000;
    ...
    while ((*(volatile uint32_t*) ((0xf0000000L + 0x3020L) + 12)) == 0);
    for(int i0 = 0; i0 < 16; i0 = i0 + 1){
        (*(volatile uint32_t*)0x2600000c) = outputsignal[i0];
    }
    for(int i1 = 0; i1 < 16; i1 = i1 + 1){
        (*(volatile uint32_t*)0x2600000c) = Mo[i1];
    }
    for(int i2 = 0; i2 < 16; i2 = i2 + 1){
        (*(volatile uint32_t*)0x2600000c) = Vo[i2];
    }

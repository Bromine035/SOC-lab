...
# 186 "fmqu.c"
 int* tmpf = fir();
 (*(volatile uint32_t*)0x2600000c) = *tmpf << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+9) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpf+10) << 16;
...
# 220 "fmqu.c"
 int *tmpm = matmul();
 (*(volatile uint32_t*)0x2600000c) = *tmpm << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpm+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpm+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpm+3) << 16;



 (*(volatile uint32_t*)0x2600000c) = *(tmpm+9) << 16;
...
# 249 "fmqu.c"
 int* tmpq = qsort();
 (*(volatile uint32_t*)0x2600000c) = *tmpq << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmpq+9) << 16;
